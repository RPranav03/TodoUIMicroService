...
const GET_TASKS_API_BASE_URL = "http://get-task.devopswalebaba.store";
const DELETE_TASK_API_BASE_URL = "http://delete-task.devopswalebaba.store";
const CREATE_TASK_API_BASE_URL = "http://add-task.devopswalebaba.store";
